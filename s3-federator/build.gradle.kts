...
group = "energy.eddie.ceeds.s3federator"
...
jib {
    ...
    to {
        image = System.getProperty("jib.to.image") ?: "ghcr.io/eddie-energy/ceeds-s3-federator"
        auth {
...
tasks.compileJava {
    ...
    if (!name.lowercase(Locale.getDefault()).contains("test")) {
        options.errorprone {
            ...
            option("NullAway:AnnotatedPackages", "energy.eddie.ceeds.s3federator")
